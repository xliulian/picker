...
function InnerPicker(props) {
  ...
  var _props$prefixCls = props.prefixCls,
    ...
    _props$withConfirmBut = props.withConfirmButton,
    withConfirmButton = _props$withConfirmBut === void 0 ? 'auto' : _props$withConfirmBut;
  var inputRef = React.useRef(null);
  var needConfirmButton = withConfirmButton !== 'auto' ? withConfirmButton : picker === 'date' && !!showTime || picker === 'time';
  // ============================ Warning ============================
  ...
  var onContextSelect = function onContextSelect(date, type) {
    if (type === 'submit' || type !== 'key' && !needConfirmButton) {
      ...
      triggerChange(date);
      if (type !== 'mouse' || !(picker === 'date' && !!showTime || picker === 'time')) {
        triggerOpen(false);
      }
    }
  };
